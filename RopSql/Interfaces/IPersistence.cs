...
namespace System.Data.RopSql.Interfaces
{
    public interface IPersistence
    {
        ...
        IList<T> List<T>(T filterEntity, List<int> primaryKeyFilters, int registryLimit, string showAttributes, Dictionary<string, double[]> rangeValues, string groupAttributes, string orderAttributes, bool onlyListableAttributes, bool getExclusion, bool orderDescending, bool uniqueQuery, bool loadComposition) where T : class;
        IList<T> List<T>(object filterEntity, Type entityType, bool loadComposition) where T : class;
