...
namespace System.Data.RopSql.Interfaces
{
    public interface IPersistence
    {
        ...
        List<T> List<T>(object filterEntity, Type entityType, List<int> primaryKeyFilters, int registryLimit, string showAttributes, string groupAttributes, string orderAttributes, bool onlyListableAttributes, bool getExclusion, bool orderDescending, bool uniqueQuery, bool loadComposition);
